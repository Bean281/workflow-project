 ...
 * @author Walking Bag
 */
@WebServlet(name = "SavingNoteServlet", urlPatterns = {"/SavingNoteServlet"})
public class SavingNoteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        note.setId(Long.parseLong(request.getParameter("noteid")));
        note.setUserid(Long.parseLong(request.getParameter("userid")));
        note.setTitle(request.getParameter("noteTitle"));
